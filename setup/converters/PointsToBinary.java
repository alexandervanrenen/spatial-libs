...
public class PointsToBinary {
	...
	public static void writeBinaryPoints(List<String> points, String fileName, long numPoints) {
		...
		try {
			...
			String delims = ",";
			while (itr.hasNext() && count <= numPoints) {
				String t = itr.next();
	...
	public static void main(String[] args) {
		...
		writeBinaryPoints(points, args[1], 50000000);
