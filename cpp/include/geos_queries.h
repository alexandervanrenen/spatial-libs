...
static uint64_t strtree_distance_query(geos::index::strtree::STRtree& strtree, geos::geom::Geometry* target_point, geos::geom::Geometry* target_range, GEOSGeometry& points, double distance) {
	std::vector<geos::geom::Geometry*> result;
	result.reserve(1e8);
	std::vector<void*> candidates;
	strtree.query(target_range->getEnvelopeInternal(),candidates);
...
static uint64_t quadtree_distance_query(geos::index::quadtree::Quadtree& quadtree, geos::geom::Geometry* target_point, geos::geom::Geometry* target_range, double distance) {
	std::vector<geos::geom::Geometry*> result;
	result.reserve(1e8);
	std::vector<void*> candidates;
	quadtree.query(target_range->getEnvelopeInternal(),candidates);
...
static uint64_t strtree_distance_query_own(geos::index::strtree::STRtree& strtree, geos::geom::Geometry* target_point, geos::geom::Geometry* target_range, double distance) {
	std::vector<geos::geom::Geometry*> result;
	result.reserve(1e8);
	std::vector<void*> candidates;
...
static uint64_t quadtree_distance_query_own(geos::index::quadtree::Quadtree& quadtree, geos::geom::Geometry* target_point, geos::geom::Geometry* target_range, double distance) {
	std::vector<geos::geom::Geometry*> result;
	result.reserve(1e8);
	std::vector<void*> candidates;
	const geos::geom::Coordinate* c1 = target_point->getCoordinate();
...
static std::vector<unsigned> strtree_on_points_join(geos::index::strtree::STRtree& strtree, GEOSGeometry& polygons, GEOSPreparedGeometry& prepared_polygons) {
...
static std::vector<unsigned> quadtree_on_points_join(geos::index::quadtree::Quadtree& quadtree, GEOSGeometry& polygons, GEOSPreparedGeometry& prepared_polygons) {
	std::vector<unsigned> counts(polygons.geometry.size(), 0);
...
static std::vector<unsigned> strtree_on_polygons_join(geos::index::strtree::STRtree& strtree, GEOSGeometry& points, GEOSPreparedGeometry& prepared_polygons) {
...
static std::vector<unsigned> quadtree_on_polygons_join(geos::index::quadtree::Quadtree& quadtree, GEOSGeometry& points, GEOSPreparedGeometry& prepared_polygons) {
	std::vector<unsigned> counts(prepared_polygons.prepared_geometry.size(), 0);
